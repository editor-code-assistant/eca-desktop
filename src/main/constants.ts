...
// Retry policy for small HTTP fetches (releases API and artifact checksums).
...
// api.github.com could otherwise interrupt provisioning or force the
// cached-binary offline path.
